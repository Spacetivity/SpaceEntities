...
class EntityMetadataRegistry {
    ...
    object FakePlayer : MetadataType {
        override val metadataTypes: MutableSet<EntityMetadata<*>> = mutableSetOf()
        ...
        init {
            metadataTypes.add(CAPE_ENABLED)
            metadataTypes.add(JACKET_ENABLED)
            metadataTypes.add(LEFT_SLEEVE_ENABLED)
            metadataTypes.add(RIGHT_SLEEVE_ENABLED)
            metadataTypes.add(LEFT_PANTS_LEG_ENABLED)
            metadataTypes.add(RIGHT_PANTS_LEG_ENABLED)
            metadataTypes.add(HAT_ENABLED)
            metadataTypes.add(IS_ON_FIRE)
        }
    }
    ...
    interface MetadataType {
        val metadataTypes: MutableSet<EntityMetadata<*>>
    }
